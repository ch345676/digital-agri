...
await go('map');await page.click('polygon[points^="70,160"]');await has('安排灌溉');await click('安排灌溉','main');assert.ok((await stored()).tasks.some(t=>t.title.includes('灌溉作业')));checks.push('existing interactive map and irrigation task')
